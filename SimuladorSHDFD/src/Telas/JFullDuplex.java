...
public class JFullDuplex extends JFrame{
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFullDuplex frame = new JFullDuplex();
	...
	private void iniComponentes() {
		...
		lblNewLabel.setIcon(new ImageIcon(JFullDuplex.class.getResource("/Image/Computer-icon.png")));
		lblNewLabel.setBounds(10, 93, 96, 94);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(JFullDuplex.class.getResource("/Image/Computer-icon.png")));
		lblNewLabel_1.setBounds(394, 29, 96, 94);
		...
		JProgressBar fullDuplexBar1 = new JProgressBar();
		fullDuplexBar1.setIndeterminate(prb2);
		fullDuplexBar1.setVisible(true);
		fullDuplexBar1.setBounds(100, 165, 285, 20);
		contentPane.add(fullDuplexBar1);
		
		BottLR.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!prb2) {
					if(prb1) {
						mensagem.setText("No modo Full-Duplex, os dois lado pode enviar e receber os dados ao memso tempo");
